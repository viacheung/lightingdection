...
$(function () {
    ...
    $('#btnSave').bind('click', function () {
        ...
        var minValue = document.getElementById("input_miValue").value;
        var maxValue = document.getElementById("input_maValue").value;
        //var msg="";
        ...
        if (method.localeCompare("add") == 0) {
            ...
            $.ajax({
                url: "addBaojing",
                data: {"datameaningId": datameaningId, "name": name, "minValue": minValue, "maxValue": maxValue},
                dataType: 'json',
                type: 'post',
