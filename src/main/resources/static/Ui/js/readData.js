...
$(function () {
    ...
    $('#btnSave').bind('click', function () {
        ...
        var startRejister = document.getElementById("input_startRejister").value;
        var rejisterNum = document.getElementById("input_rejisterNum").value;

        if (method.localeCompare("add") == 0) {
            $.ajax({
                url: "addReadData",
                data: {"datameaningId": datameaningId, "startRejister": startRejister, "rejisterNum": rejisterNum},
                dataType: 'json',
                type: 'post',
