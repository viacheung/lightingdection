...
$(function () {
    ...
    $('#btnSave').bind('click', function () {
        ...
        msg = tiaoshi.updateCF(id, chanpinId);
        ...
        $('#importDlg').dialog(
            {
                ...
                buttons: [{
                    ...
                    handler: function () {
                        ...
                        var msg = "";
                        msg = tiaoshi.CFImport(chanpinId);
...
function init() {
    var list = tiaoshi.chanpinFileListByPage(null, null, null);
    var htmllist = "";
    for (var i = 0; i < list.size(); i++) {
        htmllist += "<tr>" +
            "<td></td>" +
            "<td>" + list.get(i).getId() + "</td>" +
            "<td>" + list.get(i).getChanpinId() + "</td>" +
            "<td>" + list.get(i).getChanpinName() + "</td>" +
            "<td>" + list.get(i).getUrl() + "</td>" +
            "</tr>";
    }
    ;
    document.getElementById("chanpinFileList").innerHTML = htmllist;
}
