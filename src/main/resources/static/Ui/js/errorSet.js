...
// 加载表格数据
    ...
    $('#btnSave').bind('click', function () {
        ...
        var isOpen = document.getElementById("input_isOpen").value;
        ...
        if (method.localeCompare("add") == 0) {
            $.ajax({
                url: "addErrorSet",
                data: {"datameaningId": datameaningId, "chanpinId": chanpinId, "isOpen": isOpen, "value": value},
                dataType: 'json',
                type: 'post',
