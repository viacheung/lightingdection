...
<script>
    ...
    function download1() {
        ...
        window.location.href = "${pageContext.request.contextPath}/user/exportExcel?chanpinId=" + chanpinId + "&datameaningId=" + datameaningId + "&startDate=" + startDate + "&endDate=" + endDate;
        //link.click();
    }
    ...
    function download2() {
        ...
        //var link = document.createElement('a');
        //var a = document.getElementById("exportExcel");
        window.location.href = "${pageContext.request.contextPath}/user/exportPdf?chanpinId=" + chanpinId + "&datameaningId=" + datameaningId + "&startDate=" + startDate + "&endDate=" + endDate;
        //link.click();
    }
</script>
<script>
    layui.use(['table', 'form', 'layer', 'laydate'], function () {
        ...
        var tableIns = table.render({
            elem: '#demo', //绑定table表格
            height: 'full-60',
            url: '${pageContext.request.contextPath}/user/showBaojingRecord' //数据接口
            ,
            page: true //开启分页
            ,
            cols: [
            ...
            active = {
                reload: function () {
                    ...
                    table.reload('testReload', {
                        page: true,
                        url: '${pageContext.request.contextPath}/user/findBaojingRecord',
                        method: 'post',
                        where: {
